...
<html>
    ...
    <body>
        ...
        <h2 class="subjudul">Universitas Muhammadiyah Prof.Dr. HAMKA</h2>
            ...
            @if($minute->documents->isNotEmpty())
                ...
                <ul>
                    @foreach($minute->documents as $document)
                        <li>{{ pathinfo($document->name, PATHINFO_FILENAME) }}</li>
                    @endforeach
                </ul>
            @endif
        </div>
        <table style="width: 100%">
            <tr>
                <td style="text-align: center">
                    ...
                    <img src="{{ isset($minute->signature_minute) ? storage_path('signature/'.$minute->signature_minute) : '' }}" alt="signature"
                ...
                <td style="text-align: center">
                    ...
                    <img src="{{ isset($minute->signature_minute_notulis) ? storage_path('signature/'.$minute->signature_minute_notulis) : '' }}" alt="signature"
                    width="100" height="100">
